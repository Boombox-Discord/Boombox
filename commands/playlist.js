...
module.exports = {
  name: "playlist",
  description: "Plays all songs from a youtube playlist, spotify album or spotify playlist.",
  args: true,
  ...
  data: new SlashCommandBuilder()
    .setName('playlist')
    .setDescription('Plays all songs from a youtube playlist, spotify album or spotify playlist.')
    .addStringOption(option => option.setName('playlisturl').setDescription('Youtube URL, spotify album or playlist URL.').setRequired(true)),
